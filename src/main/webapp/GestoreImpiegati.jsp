          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="EmployeeServlet?action=add" method="post" onsubmit="return validate(this)">
                  ...
                  <select name="tipo">
                    <option value="">Seleziona il tipo di gestore</option>
                    <option value="party">Gestore Party</option>
                    <option value="impiegati">Gestore Impiegati</option>
                    <option value="contabile">Contabile</option>
                    <option value="pacchetti">Gestore Pacchetti</option>
                  </select>
                  <div class="pt-1 mb-4">
                    <input type="submit" value="Inserisci" class="btn btn-dark btn-lg btn-block">
                  </div>
                </form>
